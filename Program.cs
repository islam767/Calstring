...
namespace GeometryGuruuu
{
      class Program
    {
        static void Main(string[] args)
        {
            ...
            // BARCHA BOSQICHLARNI SHU YERGA (Main ichiga) YOZAMIZ
            
            // 1-bosqich: So'rash
            Console.Write("Misolni kiriting: ");
            ...
            // 2 va 3-bosqich: Hisoblash (While sikli)
            ...
            Console.ReadKey(); // Dastur to'xtab turishi uchun
        */
